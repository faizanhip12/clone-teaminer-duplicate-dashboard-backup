...
import { CountrySelect, InputField } from 'src/@core/components/form'
import FileUploaderRestrictions from 'src/@core/components/apps/playlist/components/FileUploader'
import { useRouter } from 'next/router'
import dynamic from 'next/dynamic'
import { useTheme } from '@mui/material/styles'
import CataloguesMultiSelect from 'src/@core/components/apps/playlist/components/CataloguesMultiSelect'
...
const CKeditor = dynamic(() => import('src/@core/components/apps/playlist/components/CKEditor'), {
