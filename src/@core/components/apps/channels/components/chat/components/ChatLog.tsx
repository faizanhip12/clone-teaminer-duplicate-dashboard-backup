      ...
      return (
        ...
        >
          <Box>
            ...
            >
              {data?.profile_picture ? getInitials(data?.name || data?.fullName) : null}
            </CustomAvatar>
          </Box>
            ...
            <Box>
              <Typography
                sx={{
                  ...
                  color: isSender ? 'customColors.themeColor' : 'common.white',
                  backgroundColor: isSender ? 'primary.main' : 'common.black'
                }}
              >
                {item?.message}
              </Typography>
