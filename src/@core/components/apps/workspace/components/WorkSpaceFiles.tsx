  ...
  return (
    <>
      ...
      >
        {File?.map((file: any) => {
          return (
            <Box className='keen-slider__slide' width={200} marginRight={'10px'} key={file?.id}>
              <Card
                sx={{
                  maxWidth: 345,
                  minWidth: 200,
              ...
              >
                ...
                <Tooltip title='Click to download'>
                  <CardContent sx={{ p: 1, justifyContent: 'center', cursor: 'pointer' }}>
                    <Link href={file?.public_source_url}>
