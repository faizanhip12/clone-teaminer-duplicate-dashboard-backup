...
const defineRulesFor = (role: string, subject: string) => {
  ...
  if (role === 'SUPER_ADMIN') {
    ...
    can('itsHaveAccess', 'single-community-page')
    ...
    can('itsHaveAccess', 'course-catalogue-page')
    can('itsHaveAccess', 'firebase-page')
    can('itsHaveAccess', 'all-courses-catalogues-page')
    ...
    can('itsHaveAccess', 'all-courses-catalogues-page')
    can('itsHaveAccess', 'firebase-page')
    can('itsHaveAccess', 'my-certificates-page')
