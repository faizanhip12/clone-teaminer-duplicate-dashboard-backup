...
const Services = {
  ...
  getAllMilestones(): Promise<AxiosResponse> {
    return requests.get(`/auth/student/milestone`)
  },
  ...
  getAllAdminData(): Promise<AxiosResponse> {
    return requests.get(`auth/dashboard`)
  },
  getAllTeacherData(): Promise<AxiosResponse> {
    return requests.get(`auth/dashboard`)
  },
  getAllStudentData(): Promise<AxiosResponse> {
    return requests.get(`auth/dashboard`)
  },
