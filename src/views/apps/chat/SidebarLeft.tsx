...
const SidebarLeft = (props: ChatSidebarLeftType) => {
  ...
  const renderChats = () => {
    if (store && store?.chats && store?.chats?.length) {
      if (query?.length && !filteredChat?.length) {
        return (
          <ListItem>
            <Typography sx={{ color: theme.palette.common.white }}>No Chats Found</Typography>
          </ListItem>
        )
      } else {
              ...
              <ListItemButton
                ...
                sx={{
                  ...
                  backgroundColor: (theme: Theme) =>
                    activeCondition ? `${theme.palette.customColors.themeColor} !important` : ''
                }}
              >
                {user && chat && (
                  <ChatProfile
                ...
                >
                  ...
                  >
                    ...
                    <ListItemText
                      ...
                      primary={
                        <Typography sx={{ ...(!activeCondition ? { color: 'common.white' } : {}) }}>
                      ...
                      secondary={
                        <Typography
                          noWrap
                          variant='body2'
                          sx={{ color: !activeCondition ? (theme: Theme) => 'common.white' : {} }}
                        >
                          {contact.about || 'About'}
                        </Typography>
                      }
  ...
  return (
    <>
      <Box borderRight={`1px solid ${theme.palette.customColors.bodyBg}`}>
        <Drawer
